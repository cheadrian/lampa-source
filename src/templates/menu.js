    ...
    <div class="menu__case">
        <ul class="menu__list">
            ...
            <li class="menu__item selector" data-action="filter">
                ...
                <div class="menu__text" data-i18n="menu.filter">Фильтр</div>
            </li>
            <li class="menu__item selector" data-action="collections">
                <div class="menu__ico"><img src="./img/icons/menu/catalog.svg" /></div>
                <div class="menu__text" data-i18n="menu.collections">Подборки</div>
            </li>
            <li class="menu__item selector" data-action="relise">
                ...
                <div class="menu__text" data-i18n="menu.relise">Релизы</div>
            </li>
            <li class="menu__item selector" data-action="anime">
                ...
                <div class="menu__text" data-i18n="menu.anime">Аниме</div>
            </li>
        </ul>
    </div>
    ...
    <div class="menu__case">
        <ul class="menu__list">
            ...
            <li class="menu__item selector" data-action="favorite" data-type="history">
                ...
                <div class="menu__text" data-i18n="menu.history">История</div>
            </li>
            ...
            <li class="menu__item selector" data-action="timetable">
                ...
                <div class="menu__text" data-i18n="menu.timetable">Расписание</div>
            </li>
            ...
            <li class="menu__item selector" data-action="mytorrents">
                ...
                <div class="menu__text" data-i18n="menu.mytorrents">Торренты</div>
            </li>
        </ul>
    </div>
    ...
    <div class="menu__case">
        <ul class="menu__list">
            <li class="menu__item selector" data-action="settings">
                ...
                <div class="menu__text" data-i18n="menu.settings">Настройки</div>
            </li>
            ...
            <li class="menu__item selector" data-action="console">
                ...
                <div class="menu__text" data-i18n="menu.console">Консоль</div>
            </li>
        </ul>
    </div>
</div>`

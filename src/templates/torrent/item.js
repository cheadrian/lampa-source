let html = `<div class="torrent-item selector">
    ...
    <div class="torrent-item__details">
        ...
        <div class="torrent-item__bitrate bitrate"><span data-i18n="torrent.item.bitrate">Битрейт:</span> <span>{bitrate} <span data-i18n="torrent.item.speed">Мбит/с</span></span></div>
